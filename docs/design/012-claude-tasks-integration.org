...
** Backlog as Universal Hub

The backlog is the central hub—tasks can originate anywhere (or nowhere):
...
#+begin_example
        ...
        │               │               │
        ▼               ▼               ▼
   Design Doc      Claude Task     GitHub Issue
   :DESIGN:        :CLAUDE_TASK:   :GITHUB:
#+end_example

*** Task Origins

Tasks in backlog.org can come from:

| Origin         | Link Property   | Example                          |
|----------------+-----------------+----------------------------------|
| Design doc     | =:DESIGN:=      | Planned feature work             |
| GitHub issue   | =:GITHUB:=      | Bug report, external request     |
| Claude Task    | =:CLAUDE_TASK:= | Agent-created during execution   |
| Direct entry   | (none)          | Ad-hoc work, quick fixes         |

*All link properties are optional.* A task can have:
- Multiple links (same task tracked in multiple systems)
- One link (task originated somewhere specific)
- No links (ad-hoc work added directly to backlog)

*** Direct-to-Backlog Workflow

For quick work that doesn't warrant a design doc:

#+begin_example
Human adds task directly to backlog.org:
*** TODO Fix typo in README
:PROPERTIES:
:EFFORT: S
:END:

When Claude starts work, skill adds :CLAUDE_TASK: link automatically.
...
*** DONE [DAB-012-08] Create claude-tasks-sync skill                     :p0:
CLOSED: [2026-01-26]
:PROPERTIES:
:EFFORT: M
:COMPLETED_BY: claude-code
...
*** DONE [DAB-012-09] Add :CLAUDE_TASK: support to task-start            :p1:
CLOSED: [2026-01-26]
:PROPERTIES:
:EFFORT: M
:COMPLETED_BY: claude-code
...
*** DONE [DAB-012-10] Update backlog-resume for :CLAUDE_TASK:            :p1:
CLOSED: [2026-01-26]
:PROPERTIES:
:EFFORT: S
:COMPLETED_BY: claude-code
...
*** DONE [DAB-012-11] Update queue-design-doc for plan mode              :p0:
CLOSED: [2026-01-26]
:PROPERTIES:
:EFFORT: M
:COMPLETED_BY: claude-code
...
*** DONE [DAB-012-13] Create /task-link command                          :p2:
CLOSED: [2026-01-26]
:PROPERTIES:
:EFFORT: M
:COMPLETED_BY: claude-code
...
- *2026-01-26:* Completed DAB-012-11 (queue-design-doc plan mode integration)
- *2026-01-26:* Implemented DAB-012-08, 09, 10 (sync skill, task-start, backlog-resume)
